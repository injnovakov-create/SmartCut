...
with col1:
    ...
    # Ако използваш draw_mini_preview, тя трябва да е дефинирана. 
    # За да не даде грешка, я прескачаме ако не си я дефинирал горе.
    try:
